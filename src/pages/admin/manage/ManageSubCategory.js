...
function ManageSubCategory() {
  ...
  function GetSubCategory() {
    axios
      .post(`${URL}admin/manage-sub-category`, {
        action: "view",
      })
      .then((res) => {
        if (res.data.length > 0) {
        ...
        axios
          ...
          .then((res) => {
            ...
            if (res.data === "deleted") {
              ...
              Swal.fire("Deleted!", "Sub-Category Deleted.", "success");
            } else {
              Swal.fire(
                "Foreign Key Error!",
  ...
  const ShowEditModal = (id) => {
    // console.log(id);
    let oneSubCategory = subcategory.filter(
      (value) => value.subcategoryid === id
    );
        ...
        <Modal.Body>
          <form id={"category-form"} className="form-signin">
            <div className="ui form">
              ...
              <div className="form-group">
                <button
                  onClick={handle_Add_SubCategory}
                  type="button"
      ...
      >
        ...
        <Modal.Body>
          <form id={"category-form-edit"}>
            ...
            <button
              onClick={handle_Update_SubCategory}
              type="button"
