...
function ManageProduct() {
  ...
  const handle_Add_Product = () => {
    ...
    if (
      ...
      axios
        .post(`${URL}admin/manage-product`, formData)
        .then((res) => {
  ...
  const handle_Update_Product = () => {
    let { category, subcategory, id, product, price, discount, description } =
      editData;
    ...
    if (subcategory && product && price && discount && description) {
      ...
      axios
        .post(`${URL}admin/manage-product`, form_Data)
        .then((res) => {
          if (res.status === 200 && res.statusText === "OK") {
            // console.log(res.data);
        ...
        <main className="main">
          ...
          <section className="mt-10 mb-10">
            <div className="container">
              <div className="row">
                <div className="col-lg-12 col-md-10 col-sm-10 col-12 mx-auto">
                  <div className={"mb-4"}>
                    <Button
                  ...
                  <div className="form-group">
                    ...
                    >
                      ...
                      {subcategory.map((value, index) => {
                        return (
                          <option key={index} value={value.subcategoryid}>
                  ...
                  >
                    ...
                    {subcategory.map((value, index) => {
                      return (
                        <option
                          selected={
                            editData.subcategory === value.subcategoryid
                          }
                          key={index}
